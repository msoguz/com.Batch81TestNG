...
public class C03_E2ETest {
    ...
    public void E2ETest() throws InterruptedException {
        ...
        actions.sendKeys(Keys.TAB).sendKeys("Happy Hotel").sendKeys(Keys.TAB).sendKeys("1500")
                ...
                .sendKeys(Keys.TAB).sendKeys("asdasgasdfa").sendKeys(Keys.TAB).sendKeys(Keys.SPACE)
