...
public class C02_DataProvider {
    ...
    public static Object[][] kullanicilar() {
        return new Object[][]{{"alitut@gmail.com", "123545"},{"cemal@gmail.com, 54321"},{"enginar@gmail.com, 112233"}};
    }
    ...
    public void test01(String userEmail, String password) throws InterruptedException {
        ...
        brc.brcemailTextBox.sendKeys(userEmail);
        Actions actions=new Actions(Driver.getDriver());
        actions.sendKeys(Keys.TAB).sendKeys(password)
                .sendKeys(Keys.ENTER).perform();

        //Degerleri girildiginde sayfaya basarili sekilde girilemedigini test et
        Assert.assertTrue(brc.brcikinciLoginButonu.isDisplayed());
