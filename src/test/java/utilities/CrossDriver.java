...
public class CrossDriver {
    ...
    */
    ...
    public static WebDriver getDriver(String browser) {
        //Eger browser'a deger atanmamissa ConfigReader'daki browser calissin.
        browser = browser == null ? ConfigReader.getProperty("browser") : browser;
        //Testlerimizi .xml file'dan farkli browser ile calistirabilmek icin getDriver() methoduna
